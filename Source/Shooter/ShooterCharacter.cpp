...
(
	const FVector& MuzzleSocketLoction,
...
void AShooterCharacter::SendBullet()
{
	...
	if (BarrelSocket)
	{
		...
		if (bBeamEnd)
		{
			// Spawn impact particles after BeamEndPoint
			if (ImpactParticles)
			{
...
void AShooterCharacter::ReloadWeapon()
{
	...
	// If we are not carrying any ammo or the clip is full
...
void AShooterCharacter::InterpCapsuleHaflHeight(float DeltaTime)
{
	float TargetCapsuleHalfHeight = bCrouching
...
void AShooterCharacter::Tick(float DeltaTime)
{
	...
	InterpCapsuleHaflHeight(DeltaTime);
}
...
FVector AShooterCharacter::GetCamerInterpLocation()
{
